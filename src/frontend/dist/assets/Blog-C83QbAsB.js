import { j as jsxRuntimeExports, L as Link, S as Skeleton } from "./index-D6M-L3AT.js";
import { B as Badge } from "./badge-BfFuspmz.js";
import { a as useGetBlogPosts } from "./useQueries-BmWb2bzh.js";
...
const FALLBACK_POSTS = [
  {
    ...
    excerpt: "Modern rice mills demand precision automation. Learn how PLC-based control systems optimise cleaning, milling, and grading sections to reduce waste and boost throughput.",
    content: "",
    date: BigInt((/* @__PURE__ */ new Date("2024-02-12")).getTime()),
  ...
  },
  {
    ...
    excerpt: "Real-time monitoring, remote access, and data analytics: how SCADA systems are transforming food processing plants across India from reactive to predictive operations.",
    content: "",
    date: BigInt((/* @__PURE__ */ new Date("2024-04-18")).getTime()),
    author: "Teja Controls Engineering Team",
    category: "SCADA",
    readTime: "8 min read"
  },
  {
    ...
    excerpt: "Investing in automation is a business decision. We break down the hard numbers — energy savings, labour reduction, yield improvement, and payback periods for flour mill automation.",
    content: "",
    date: BigInt((/* @__PURE__ */ new Date("2024-06-05")).getTime()),
    author: "Teja Controls Engineering Team",
  ...
  },
  {
    ...
    excerpt: "A poorly designed control panel is a liability. Our senior engineers share the design principles — component selection, cable management, thermal design — that ensure 99.9% uptime.",
    content: "",
...
const SLUG_IMAGE_MAP = {
  "plc-programming-for-rice-mills": "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
  "scada-benefits-for-food-processing": "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=800&q=80",
  "automation-roi-for-flour-mills": "https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=800&q=80",
  "control-panel-design-best-practices": "https://images.unsplash.com/photo-1565043589221-1a6fd9ae45c7?w=800&q=80"
};
function getPostImage(slug) {
  return SLUG_IMAGE_MAP[slug] ?? "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&q=80";
}
    ...
    motion.article,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-48 overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "absolute top-3 left-3 bg-secondary/90 text-white border-0 text-xs font-body", children: post.category })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col flex-1 p-6 gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-lg font-bold text-foreground leading-snug group-hover:text-secondary transition-colors duration-200 line-clamp-2", children: post.title }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between pt-3 border-t border-border", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-body font-medium text-foreground truncate max-w-[140px]", children: post.author }),
...
function BlogPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "blog.page", className: "min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative bg-primary text-primary-foreground py-24 px-6 overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 opacity-10 bg-[radial-gradient(ellipse_at_top_right,oklch(0.58_0.17_30)_0%,transparent_60%)]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-4xl mx-auto text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 bg-secondary/20 border border-secondary/30 rounded-full px-4 py-1.5 mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "w-4 h-4 text-secondary" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-body font-semibold text-secondary", children: "Automation Insights" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight mb-5", children: "Automation Insights" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg sm:text-xl font-body text-primary-foreground/80 max-w-2xl mx-auto leading-relaxed", children: "Expert knowledge on PLC programming, SCADA systems, and industrial automation — from our engineering team in the field." })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 bg-secondary" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-background py-16 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-2xl font-semibold text-foreground mb-2", children: "Ready to automate your plant?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body mb-6", children: "Our engineers have designed and commissioned 500+ projects across India. Let's discuss your requirements." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                to: "/contact",
